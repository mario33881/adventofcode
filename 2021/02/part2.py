...
class Submarine:
    def __init__(self) -> None:
        ...
        * aim: used to calculate the depth
    ...
    def forward(self, value):
        ...
        increases the depth by your aim multiplied by <value>.
        """
        self.position.x += value
        self.position.y += self.aim * value

    def up(self, value):
        """
        decreases the aim by <value> units
        """
        self.aim -= value

    def down(self, value):
        """
        increases the aim by <value> units
        """
        self.aim += value
